...
* [Spring Cache Abstraction](https://docs.spring.io/spring-boot/3.5.11-SNAPSHOT/reference/io/caching.html)
* [Spring Data JPA](https://docs.spring.io/spring-boot/3.5.11-SNAPSHOT/reference/data/sql.html#data.sql.jpa-and-spring-data)
* [Spring Data Redis (Access+Driver)](https://docs.spring.io/spring-boot/3.5.11-SNAPSHOT/reference/data/nosql.html#data.nosql.redis)
